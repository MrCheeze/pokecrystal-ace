local ret = os.execute("sh C:/Users/Matt/Documents/git/crystal-ace/crystal.sh")
if ret ~= 0 then
	print("Error " .. ret)
end
local f = io.open("C:/Users/Matt/Documents/git/crystal-ace/crystal.o", "rb")
f:read(0x1D)
...
local f = io.open("C:/Users/Matt/Documents/git/crystal-ace/crystal.gb", "rb")
